...
export default function SubMenu({ showsub, itemName, setshow }) {
  ...
  return (
    <>
      <div
        className={`absolute lg:items-center lg:justify-center duration-300 px-5 py-2 my-0   z-20 top-0 ${showsub?"left-0 lg:scale-y-100 ":"-left-full lg:scale-y-0 lg:origin-top lg:left-0 "} flex flex-col h-[105%] lg:h-42 lg:top-[95%] w-full text-white bg-amber-500  `}
      >
        ...
        <div className="lg:flex lg:gap-5 lg:flex-wrap  lg:items-center relative h-screen  lg:h-auto lg:justify-center">
          {College.map((items) => (
            <div
              key={items}
              className={` duration-150 roboto py-2 my-1 lg:py-0 lg:my-0 border-b-2 hover:bg-gradient-to- from-amber-500 bg-amber-500 tobg-amber-500  ${
          ...
          {Administration.map((items) => (
            <div
              key={items}
              className={` duration-150 roboto py-2 my-1 lg:py-0 lg:my-0 border-b-2 hover:bg-gradient-to- from-amber-6bg-amber-500 tobg-amber-500  ${
