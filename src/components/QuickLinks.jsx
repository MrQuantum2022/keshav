    ...
    <>
      <div className="flex relative flex-col   mb-7">
        <div className="flex relative z-10 bg-red-700 justify-center roboto-slab-b   text-white text-2xl ">
          ...
          <img src={wall} className="absolute z-0 object-contain md:h-full md:w-full md:object-cover    " alt="" />
          <img src={wall} className="absolute z-0 bottom-0  object-contain lg:hidden" alt="" />
        <div className="grid grid-cols-2 lg:grid-cols-6 text-black border border-black ">
