...
export default function Ugadmission() {
    ...
    return (
      <div className='m-3 lg:m-0 lg:scale-95  shadow-md relative shadow-slate-600 w-full lg:w-1/3'>
        ...
        <div className='text-white py-2 text-3xl font-semibold flex mx-10 my-4 scale-105 border-b-2 border-white'>{`Downloads ${year}-${year%2000+1}`} </div> 
          <div className='h-[400px] relative text-center z-10 flex-grow overflow-y-auto font-bold scroll-smooth'>
